    ...
    <FooterContainer>
      <FooterGrid>
        <FooterSection>
          ...
          <FooterList>
            <li>
              <a href="/research-residency">Research Index</a>
            </li>
            <li>
              <a href="/research-residency"> Research Overview</a>
            </li>
            <li>
              <a href="/research-residency"> Research Residency</a>
            </li>
          </FooterList>
          ...
          <FooterList>
            <li>
              <a href="/openai-o3">OpenAI o3</a>
            </li>
            <li>
              <a href="/openai-o4-mini">OpenAI o4-mini</a>
            </li>
            <li>
              <a href="/gpt-4o">GPT-4o</a>
            </li>
            <li>
              <a href="/gpt-4o-mini">GPT-4o mini</a>
            </li>
            <li>
              <a href="/sora">Sora</a>
            </li>
          ...
          <FooterList>
            <li>
              <a href="/safety-approach">Safety Approach</a>
            </li>
            <li>
              <a href="/security-privacy">Security & Privacy</a>
            </li>
            <li>
              <a href="/trust-transparency">Trust & Transparency</a>
            </li>
          </FooterList>
        </FooterSection>
        ...
        <FooterSection>
          ...
          <FooterList>
            <li>
              <a href="/explore-chatgpt">Explore ChatGPT</a>
            </li>
            <li>
              <a href="/team">Team</a>
            </li>
          ...
          <FooterList>
            <li>
              <a href="/sora-overview">Sora Overview</a>
            </li>
            <li>
              <a href="/features">Features</a>
            </li>
            <li>
              <a href="/sora-pricing">Pricing</a>
            </li>
            <li>
        ...
        <FooterSection>
          ...
          <FooterList>
            ...
            <li>
              <a href="/overview"> Solutions</a>
            </li>
            <li>
              <a href="/overview">Contact Sales</a>
            </li>
          </FooterList>
          ...
          <FooterList>
            ...
            <li>
              <a href="/our-charter">Our Charter</a>
            </li>
            <li>
      ...
      <BottomSection>
        <SocialLinks>
          ...
          <a
            href="https://instagram.com/openai"
            target="_blank"
            rel="noopener noreferrer"
          >
            <svg viewBox="0 0 24 24" fill="currentColor">
        ...
        <Copyright>OpenAI © 2015–2025 Manage Cookies</Copyright>

        <LanguageSelector>
          <a href="/language/english">English United States</a>
        </LanguageSelector>
      </BottomSection>
    </FooterContainer>
  );
